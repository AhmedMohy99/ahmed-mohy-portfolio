...
export function PortfolioChatbot() {
  ...
  return <>
    <button type="button" onClick={() => setOpen(true)} className="fixed bottom-6 right-6 z-[70] flex items-center gap-3 rounded-full border border-[var(--line-strong)] bg-[var(--ink)] px-5 py-3 text-sm text-white shadow-[0_18px_50px_rgba(20,18,15,.22)] transition-transform hover:-translate-y-1" aria-label="Open Ahmed AI Assistant"><Bot size={17} /><span className="hidden sm:inline">Ask Ahmed AI</span><MessageCircle size={15} className="sm:hidden" /></button>
