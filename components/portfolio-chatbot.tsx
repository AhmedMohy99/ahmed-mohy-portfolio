...
const copy = {
  en: { title: 'Ahmed AI Assistant', subtitle: 'Ask about projects, services or starting a project.', welcome: "Hi 👋 I'm Ahmed's portfolio assistant. How can I help?", placeholder: 'Ask me anything…', send: 'Send', language: 'العربية', restart: 'New chat', call: 'Arrange a call', live: 'Talk to live agent', starters: ['What services do you offer?', 'Tell me about your AI work', 'How can I contact Ahmed?'], close: 'Close assistant' },
  ar: { title: 'مساعد أحمد الذكي', subtitle: 'اسأل عن المشاريع أو الخدمات أو بدء مشروع جديد.', welcome: 'مرحباً 👋 أنا مساعد أحمد. كيف يمكنني مساعدتك؟', placeholder: 'اكتب سؤالك…', send: 'إرسال', language: 'EN', restart: 'محادثة جديدة', call: 'رتّب مكالمة', live: 'تحدث مع الوكيل المباشر', starters: ['ما الخدمات التي تقدمها؟', 'حدثني عن أعمال الذكاء الاصطناعي', 'كيف أتواصل مع أحمد؟'], close: 'إغلاق المساعد' },
} as const;
