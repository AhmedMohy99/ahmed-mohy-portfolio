      ...
      <div className="container">
        <div className="grid gap-12 lg:grid-cols-[.72fr_1.28fr] lg:items-start">
          ...
          <div className="agent-showcase relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#0d0d0c] p-3 shadow-[0_30px_100px_rgba(0,0,0,.35)]">
            <div className="agent-grid absolute inset-0 opacity-40" /><div className="agent-glow agent-glow-one absolute -right-20 -top-24 h-72 w-72 rounded-full bg-white/[.08] blur-3xl" /><div className="agent-glow agent-glow-two absolute -bottom-24 -left-20 h-64 w-64 rounded-full bg-white/[.05] blur-3xl" />
            <div id="cb-widget-container" className="relative min-h-[520px] overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[.075] via-white/[.025] to-transparent p-5 md:p-7" aria-label={t.aria}>
              ...
              <div className="relative flex h-full min-h-[470px] flex-col">
                <div className="flex items-center justify-between border-b border-white/10 pb-4"><div className="flex items-center gap-3"><div className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/[.06]"><Cpu size={17} className="text-white/75" /></div><div><div className="text-[9px] uppercase tracking-[.2em] text-white/35">{t.visualLabel}</div><div className="mt-1 text-sm font-medium text-white/80">{t.visualTitle}</div></div></div><div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[.04] px-3 py-1.5 text-[9px] uppercase tracking-[.12em] text-white/45"><span className="agent-status-dot h-1.5 w-1.5 rounded-full bg-white/70" /> {t.status}</div></div>
                <div className="relative flex flex-1 items-center justify-center py-8"><div className="agent-orbit agent-orbit-a absolute h-64 w-64 rounded-full border border-white/10" /><div className="agent-orbit agent-orbit-b absolute h-44 w-44 rounded-full border border-white/[.08]" /><div className="agent-core relative flex h-32 w-32 flex-col items-center justify-center rounded-full border border-white/15 bg-white/[.07] shadow-[0_0_80px_rgba(255,255,255,.08)] backdrop-blur-md"><Sparkles size={22} className="text-white/75" /><span className="mt-2 text-[9px] uppercase tracking-[.18em] text-white/40">AI CORE</span></div><div className="agent-node agent-node-a"><Activity size={13} /> <span>ANALYZE</span></div><div className="agent-node agent-node-b"><Zap size={13} /> <span>QUALIFY</span></div><div className="agent-node agent-node-c"><ArrowUpRight size={13} /> <span>HANDOFF</span></div></div>
                <div className="rounded-2xl border border-white/10 bg-black/20 p-4 backdrop-blur-sm"><div className="flex items-center gap-2 text-[9px] uppercase tracking-[.18em] text-white/35"><CheckCircle2 size={13} /> {t.recommendation}</div><div className="mt-2 text-sm leading-6 text-white/70">{t.recommendationText}</div><div className="mt-4 grid grid-cols-3 gap-2">{t.metrics.map((metric, index) => <div key={metric} className="rounded-xl border border-white/[.07] bg-white/[.03] p-3 text-center"><div className="text-[8px] uppercase tracking-[.12em] text-white/30">{metric}</div><div className="mt-2 text-sm font-medium text-white/70">{['98%', '94%', '91%'][index]}</div></div>)}</div></div>
